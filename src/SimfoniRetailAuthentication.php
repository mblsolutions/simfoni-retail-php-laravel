...
class SimfoniRetailAuthentication
{
    ...
    /** @var SimfoniRetailAuth $authentcation */
    protected $authentication;

    /**
     * Simfoni Retail Authentication
     *
     * @param SimfoniRetailAuth $authentication
     */
    public function __construct(SimfoniRetailAuth $authentication = null)
    {
     ...
     *
     * @param string $key
     * @return SimfoniRetailAuthentication
     */
